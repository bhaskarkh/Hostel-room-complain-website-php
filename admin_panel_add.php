...
$sql = "SELECT * FROM staff where username='admin' and password='$admin_password'";
$result=mysqli_query($con,$sql);
$row=mysqli_fetch_array($result,MYSQLI_ASSOC);  
   
if($row!=0)
{
  $sqly="INSERT into staff (username,password,category) VALUES ('$username','$password','$category')";

$result2=mysqli_query($con,$sqly);
  if($result2)
   {
     $err="Technician Added Successfully";
   }
}
else
  {
  $err="Admin password Entered is Wrong";
   }
}
 ?>
...
<div class="collapse navbar-collapse" id="myNavebar">
  <ul class="nav navbar-nav topMenu">
    ...
    <li class="active"><a href="admin_panel_add.php">Add Technician</a></li>
...
<div class="col-sm-12">
<input type="text" name="username" placeholder="Technician Name" class="form-control">
</div>
</div>

<div class="form-group">
<div class="col-sm-12">
<input type="text" name="password" placeholder="Technician password" class="form-control">
</div>
</div>
...
<div class="form-group">
<div class="col-sm-12">
<input type="password" name="admin_password" placeholder="Enter Admin  password agin" class="form-control">
</div>
</div>
