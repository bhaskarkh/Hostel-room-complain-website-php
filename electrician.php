...
if($staff_category=='admin' || $staff_category=='electrician')
{}
else
...
$query = "UPDATE complain SET status='$fav',techname='$user_check',complet_time='$date1'
...
<th class="techname">Technician</th>
...
require"conn.php";
$sid=0;
$query = "SELECT * FROM complain  where category='electrician' order by id DESC"; 
